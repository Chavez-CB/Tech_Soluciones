...
import { SidebarNav, MobileTopBar } from "@/components/dashboard/SidebarNav";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tech Soluciones · Inteligencia de Ventas" },
      { name: "description", content: "Panel, estadísticas, predicciones e historial de ventas de laptops e impresoras." },
      { property: "og:title", content: "Tech Soluciones · Inteligencia de Ventas" },
